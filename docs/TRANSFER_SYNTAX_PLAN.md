...
| High-Throughput JPEG 2000 Lossless | `1.2.840.10008.1.2.4.201` | Lossless Pixel Data encode/decode through OpenJPH reversible HTJ2K codestreams | `DICOMLIB_WITH_HTJ2K` | `transfer_syntax_roundtrip` with HTJ2K |
...
| High-Throughput JPEG 2000 RPCL Lossless and general HTJ2K | `1.2.840.10008.1.2.4.202`, `.203` | OpenJPH | Dependencies declared; codec integration not implemented |
