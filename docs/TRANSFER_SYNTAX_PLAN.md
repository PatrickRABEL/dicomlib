...
| --- | --- | --- | --- |
| Legacy JPEG Baseline/Extended/Lossless | `1.2.840.10008.1.2.4.50`, `.51`, `.57`, `.70` and retired JPEG process UIDs in the generated UID registry | GDCM and/or libjpeg/libjpeg-turbo, depending on process | Dependencies declared; codec integration not implemented |
...
The current macOS workspace does not detect:
