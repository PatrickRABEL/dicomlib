...
class DontCopy : public boost::noncopyable
{
...
void SimpleTest(){
	...
	class_<DontCopy, boost::noncopyable>("DontCopy")
		;
...
void AppendClientConnectionDefinition()
{
	...
	*/
	...
	class_<dicom::ClientConnection, boost::noncopyable>(
		"ClientConnection",
	...
	class_<dicom::TS>("TransferSyntax",
		...
		.def("isEncapsulated",&dicom::TS::isEncapsulated)
